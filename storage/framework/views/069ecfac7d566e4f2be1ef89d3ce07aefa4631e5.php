    ...
    <script type="text/javascript">  
       $(document).on('click', '.mark-list-add', function (e) {
        ...
        if( 1 == projectFlag ){
            ...
            $("#markListsErr").text('');
            $.ajax({
                url:"<?php echo e(route('mark-list.create')); ?>",
                type: "POST",
                dataType: "json",
                data:{ 
                    science:science,
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Project\Fingent\resources\views/mark-list/mark-list-add.blade.php ENDPATH**/ ?>