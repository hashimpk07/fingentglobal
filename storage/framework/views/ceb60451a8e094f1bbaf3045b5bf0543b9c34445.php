...
<form action="javascript:void(0)" id="colorForm" name="colorForm"  method="post">
    <div class="card-body">
        <div class="form-group">
            <input type="hidden" name="color_id" class="form-control" id="color_id"  value="<?php echo e($color->id); ?>" >
            <label for="color"> Color <span style="color:#ff0000">*</span></label>
                <input type="text" name="color" class="form-control" id="color" placeholder="Enter Color" value="<?php echo e($color->name); ?>" >
...
<?php $__env->startSection('scripts'); ?>
    ...
    <script type="text/javascript">  
        ...
        if( 1 == colorFlag ){
            ...
            $.ajax({
                url:"<?php echo e(route('color.update')); ?>",
                type: "POST",
                dataType: "json",
                data:{ 
                    id :id,
                ...
                success:function(data){
                    if( data.status == 'success' ){
                        ...
                        setTimeout(function () {
                            window.location = '<?php echo e(route('color')); ?>'
                        }, 2500);
                    }else{
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Project\TimesworldTechnology\resources\views/color/color-edit.blade.php ENDPATH**/ ?>